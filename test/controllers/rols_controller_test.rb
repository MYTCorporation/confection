...
class RolsControllerTest < ActionController::TestCase
  ...
  test "should create rol" do
    assert_difference('Rol.count') do
      post :create, rol: { Administrador: @rol.Administrador, Aprendiz: @rol.Aprendiz, Instructor: @rol.Instructor }
    end
  ...
  test "should update rol" do
    patch :update, id: @rol, rol: { Administrador: @rol.Administrador, Aprendiz: @rol.Aprendiz, Instructor: @rol.Instructor }
    assert_redirected_to rol_path(assigns(:rol))
  end
